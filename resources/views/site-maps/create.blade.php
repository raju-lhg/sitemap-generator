                ...
                <div class="p-6">
                    ...
                    <form action="{{ route('site-maps.store') }}" method="POST">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" name="created_by" id="created_by" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md @error('created_by') border-red-500 @enderror">
                            @error('created_by')
                                <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                            @enderror
                        </div>
                        <div class="mb-4">
                            ...
                            <input type="text" name="xml_path" id="xml_path" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md @error('xml_path') border-red-500 @enderror">
                            @error('xml_path')
                                <p class="mt-1 text-sm text-red-500">{{ $message }}</p>
                            @enderror
                        </div>
